...
const SignUpPage = ({ onLoginClick }: SignUpPageProps) => {
        ...
        <div className="lg:w-1/2 p-6 md:p-8 lg:p-12 flex flex-col justify-between min-h-[600px]">
          ...
          <div>
            ...
            <div className="mb-8 md:mb-10">
              ...
              <p className="text-gray-600 text-base md:text-lg">{t('signup.welcome')}</p>
            </div>
            ...
            <form className="space-y-5 md:space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${isRTL ? 'pl-12' : 'pr-12'}`}
                    placeholder={isRTL ? 'رمز عبور را تکرار کنید' : 'Confirm your password'}
                  />
                  <button
                    type="button"
              ...
              >
                ...
                <span className="text-gray-700 font-medium">{t('signup.signUpWithGoogle')}</span>
              </button>
